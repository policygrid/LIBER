...
public class EntryCreator
{
	 ...
	 */
	public void storeProperty(DependencyTreeTransformer dt, String dir) throws IOException
	{	//create a saxbuilder document
		Document doc = new Document();
		doc.addContent(new Comment("Automatically generated lexicon entry for the property " + property));
