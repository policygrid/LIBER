...
{
	private boolean shaded = false, completed = false, cardinal = false, root = false, menu = false;
	 ...
	 */
	public ClassTreeNode(String value, boolean shaded, boolean completed, boolean menu)
	{
		super(value);
		this.shaded = shaded;	
		this.completed = completed;
